        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiftFinal = table.Column<TimeOnly>(type: "time(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactPerson_ContactType_ContactTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DirPerson", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DirPerson_City_IdCity",
                        column: x => x.IdCity,
                        principalTable: "City",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DirPerson_Person_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractFinalDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Programation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Programation_Contract_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contract",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Programation_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Programation_Shift_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPerson_ContactTypeId",
                table: "ContactPerson",
                column: "ContactTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactPerson_Description",
                table: "ContactPerson",
                column: "Description",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DirPerson_IdCity",
                table: "DirPerson",
                column: "IdCity");

            migrationBuilder.CreateIndex(
                name: "IX_DirPerson_PersonId",
                table: "DirPerson",
                column: "PersonId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Programation_ContractId",
                table: "Programation",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_Programation_EmployeeId",
                table: "Programation",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Programation_ShiftId",
                table: "Programation",
                column: "ShiftId");
